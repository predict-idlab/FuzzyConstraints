...
class TransE(Model):
    ...
    def __init__(self, multimodal, loss=None, batch_size=128, p_norm = 1, norm_flag = True, margin = None, epsilon = None):
        super(TransE, self).__init__(multimodal, loss, batch_size)
